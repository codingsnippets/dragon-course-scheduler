...
//		}
	...
	public void modAvail(Term term, boolean add, Schedule schedule)
	{
		...
		for (int i = 0; i < this.coursework.get(term).size(); i++ )
		{
			if (this.coursework.get(term).get(i).getCRN() == crn )     //TODO fix this!
			{
				schedule_index = i;
				break;
			}
		...
		try
		{
			...
			System.out.print("SI: Schedule not found in coursework! Index out of bounds!");
		}
...
//		csv+=sprtr;
//
//		for(String i: this.concentration)
//		{
//			csv+=i;
//			csv+=sprtr;
//		}
